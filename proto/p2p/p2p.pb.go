...
func (m *ReylayMsg) Reset()         { *m = ReylayMsg{} }
func (m *ReylayMsg) String() string { return proto.CompactTextString(m) }
func (*ReylayMsg) ProtoMessage()    {}
func (*ReylayMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_e7fdddb109e6467a, []int{1}
}
func (m *ReylayMsg) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReylayMsg) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReylayMsg.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReylayMsg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReylayMsg.Merge(m, src)
}
func (m *ReylayMsg) XXX_Size() int {
	return m.Size()
}
func (m *ReylayMsg) XXX_DiscardUnknown() {
	xxx_messageInfo_ReylayMsg.DiscardUnknown(m)
}

var xxx_messageInfo_ReylayMsg proto.InternalMessageInfo

func (m *ReylayMsg) GetMessageData() *MessageData {
	if m != nil {
...
func (m *ReylayMsg) GetVersion() string {
	if m != nil {
		return m.Version
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ReylayMsg)(nil), "protocols.p2p.ReylayMsg")
}
...
var fileDescriptor_e7fdddb109e6467a = []byte{
	...
	,
}
...
func (m *MessageData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MsgType) > 0 {
		...
		i = encodeVarintP2P(dAtA, i, uint64(len(m.MsgType)))
		i--
		dAtA[i] = 0x3a
	}
...
func (m *ReylayMsg) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReylayMsg) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReylayMsg) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ReylayMsg) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReylayMsg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReylayMsg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
